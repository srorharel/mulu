...
// Used on Order Tracking (consumer, ADR-013) and as Suspense fallback on Washer Dashboard.
// Pass dark=true for the washer dark-surface colour scheme.
export default function MapBG({ className = '', dark = false }) {
  ...
  const blocks = dark ? '#22252f' : '#dbe2e9'
  const blockOpacity = dark ? 0.55 : 0.5
  ...
  return (
    ...
    >
      ...
      {/* City blocks */}
      <g fill={blocks} opacity={blockOpacity}>

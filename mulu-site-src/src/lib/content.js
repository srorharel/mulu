...
export const a11y = {
  ...
  statement: {
    title: 'הצהרת נגישות',
    updated: 'עודכן לאחרונה: 28 ביוני 2026',
    backHome: 'חזרה לדף הבית',
    intro: [
    ...
    coordinator: [
      { label: 'שם', value: 'עומר' },
      { label: 'טלפון', value: '052-300-8350' },
      { label: 'דוא"ל', value: 'support@muluwash.com' },
    ],
    responseNote: 'נשתדל להגיב לפנייתכם בתוך 7 ימי עסקים.',
  },
}

// Content-overrides loader for the support-app.
//
// VENDORED COPY so the support-app builds standalone on Vercel (Root Directory =
// support-app). Canonical original: ../../../src/lib/contentOverrides.js in the
// main app. Dependency-free (supabase + i18n are passed in), so keep
// behaviourally in sync with the original if its merge/cache semantics change.

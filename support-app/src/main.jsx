    ...
    resources: {
      he: {
        translation: {
          ...
          common: { loading: 'טוען...', error: 'שגיאה', cancel: 'ביטול', close: 'סגור', signOut: 'התנתקות', orderLinked: 'הזמנה #{{id}}', general: 'שאלה כללית', pending_agent: 'ממתין', assigned: 'בטיפול', resolved: 'נפתר', closed: 'סגור', copy: 'העתק', open: 'פתח', download: 'הורד' },
          cities: { holon: 'חולון', rishon_lezion: 'ראשון לציון', bat_yam: 'בת ים' },
      ...
      en: {
        translation: {
          ...
          common: { loading: 'Loading...', error: 'Something went wrong', cancel: 'Cancel', close: 'Close', signOut: 'Sign out', orderLinked: 'Order #{{id}}', general: 'General question', pending_agent: 'Waiting', assigned: 'In progress', resolved: 'Resolved', closed: 'Closed', copy: 'Copy', open: 'Open', download: 'Download' },
          cities: { holon: 'Holon', rishon_lezion: 'Rishon LeZion', bat_yam: 'Bat Yam' },

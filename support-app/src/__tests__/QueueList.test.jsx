...
i18n.use(initReactI18next).init({
  resources: { en: { translation: {
    ...
    'queue.searchPlaceholder': 'Search name or order…',
    'queue.live':       'Live',
    'queue.urgent':     'Urgent',
    'queue.empty':      'No conversations yet',
    'queue.emptySubtitle': 'Assigned conversations will appear here',
    'queue.errorLoading': 'Failed to load conversations',
    'queue.noMessages': 'No messages yet',

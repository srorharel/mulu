...
| Token | Value | Use |
|---|---|---|
| `surface` | Dark gray | Page/card backgrounds |
| `surface-elevated` | Slightly lighter | Raised panels, modals |
| `ink` | Off-white | Primary text |
| `ink-muted` | Mid-gray | Secondary text |
| `ink-subtle` | Dimmer gray | Placeholders, timestamps |
| `edge` | Subtle border | Dividers, outlines |
| `accent` | Green `#7DD9A2` | Brand color (mirrors main app) |
| `agent` | Violet `#7C3AED` | Agent-specific UI (distinguishes from washer teal, consumer green) |
